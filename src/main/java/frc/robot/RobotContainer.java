...
public class RobotContainer {
    ...
    private LimelightSubsystem m_LLSubsystem = new LimelightSubsystem();
     ...
     * edu.wpi.first.wpilibj2.command.button.CommandPS4Controller PS4}
     * controllers or {@link
    ...
    private void configureBindings() {
        ...
        m_driverController.a().whileTrue(new AimCommand(m_LLSubsystem));
    }
