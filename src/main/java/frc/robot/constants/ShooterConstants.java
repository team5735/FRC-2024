...
public class ShooterConstants {
    ...
    public static final double SHOOTER_TOP_FARTHEST_RPM = 3500.0;
    public static final double SHOOTER_BOTTOM_FARTHEST_RPM = 2250.0;
    ...
    public static final double SHOOTER_TOP_KV = 0.001925;
